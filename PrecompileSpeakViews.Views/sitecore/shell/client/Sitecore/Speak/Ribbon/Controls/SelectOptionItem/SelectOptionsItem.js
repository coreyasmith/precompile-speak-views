        ...
        Sitecore.Factories.createBaseComponent({
            ...
            init: function (object) {
                ...
                object.mousedown(function (event) {
                    jQuery.each(object.parent().find(".selected"),
                        function () {
                ...
                if (this.model.attributes.isPressed != null && this.model.attributes.isPressed === true) {
                    if (document.querySelector('div[data-sc-id="InsertOptions"]').firstElementChild !== 'undefined' &&
                        !document.querySelector('div[data-sc-id="InsertOptions"]').firstElementChild.classList.contains('selected'))
                     {
                        this.togglePressed();
                        setTimeout(function () {
                            document.querySelectorAll('[data-sc-id="ItemNameText"]')[0].value =
                                document.querySelector(".sc-display-name").innerHTML;
                            $("div[class='dialog-content']").trigger("selectOptionPressed", object);
                            document.querySelector("input[data-sc-id='ItemNameText']").focus();
                        },100);
                    }
                }
            },
            ...
            initialize: function () {
                this.init(this.$el);
                var that = this;
                $(this.el.parentElement).bind("insertOptionAdded",
